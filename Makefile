...
show_javascript:
	curl -X GET "http://${USER}:${PASSWD}@localhost:5984/example/_design/javascript/_list/csv/index?reduce=false&s=1001&e=1002&limit=10"
...
show_erlang:
	curl -X GET "http://${USER}:${PASSWD}@localhost:5984/example/_design/erlang/_list/csv/index?id=A/AA&reduce=false&s=1001&e=1002&limit=10"
